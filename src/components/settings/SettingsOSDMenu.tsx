...
import { BoolOption, PageHeader } from "./SettingsCommon";
  ...
  return (
    <Stack sx={{ minWidth: 120 }} spacing={3}>
      ...
      <FormControl>
        ...
        />
        <FormHelperText>
          Long file names selected in the OSD and menu will be shown using two
          lines.
        </FormHelperText>
      </FormControl>
      ...
      <FormControl>
        ...
        <FormHelperText>
          Delay before OSD in the menu is hidden and screen is dimmed after
          inactivity.
        </FormHelperText>
      </FormControl>
      ...
      <FormControl>
        <FormControlLabel control={<Checkbox />} label="PAL mode for menu" />
      </FormControl>
    </Stack>
  );
}
